  ...
  return (
    <div className="w-full px-4 py-10 mx-auto bg-gradient-to-r from-teal-50 to-white rounded-xl shadow-lg">
      ...
      <div className="text-center" data-aos="fade-up" data-aos-delay="50">
        ...
        <p className="text-md md:text-lg text-gray-600 mt-2" data-aos="fade-up" data-aos-delay="150">
          Hello! My name is{" "}
        ...
        <div
          className="w-20 h-1 bg-[#00BBA7] mx-auto mt-6 rounded-md"
          data-aos="zoom-in"
          data-aos-delay="250"
        ></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 mt-10 gap-8 md:px-10 md:gap-16">
        ...
        <div
          ...
          data-aos-delay="100"
        >
          <div className="relative w-[80%] max-w-xs md:max-w-sm mx-auto" data-aos="zoom-in-up" data-aos-delay="200">
            <Image
        ...
        >
          ...
          <p
            className="italic text-gray-700 mt-4 md:mt-6 leading-relaxed text-base md:text-lg"
            data-aos="fade-up"
            data-aos-delay="400"
          >
            ...
            across all devices. I love using React.js for its modularity and
            performance, and I have experience in backend development using
            Express.js.
          </p>

          {/* Contact Info */}
          <div className="mt-8 space-y-4 text-base md:text-lg">
            <p className="flex gap-2 text-gray-800" data-aos="fade-up" data-aos-delay="500">
              <FaAngleRight className="w-5 h-5 text-[#00BBA7]" />
              <strong>Phone:</strong>{" "}
              <span className="text-gray-700">+88 01631205714</span>
            </p>
            <p className="flex gap-2 text-gray-800" data-aos="fade-up" data-aos-delay="600">
              <FaAngleRight className="w-5 h-5 text-[#00BBA7]" />
              <strong>City:</strong>{" "}
              <span className="text-gray-700">Dhaka, Bangladesh</span>
            </p>
            <p className="flex gap-2 text-gray-800" data-aos="fade-up" data-aos-delay="700">
              <FaAngleRight className="w-5 h-5 text-[#00BBA7]" />
              <strong>Email:</strong>
