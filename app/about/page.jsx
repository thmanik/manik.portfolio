...
const About = () => {
  useEffect(() => {
    AOS.init({
      ...
      once: true,
      easing: "ease-in-out", // professional smooth easing
      offset: 80,
    });
  }, []);
  ...
  return (
    <div className="w-full px-4 py-10 mx-auto bg-gradient-to-r from-teal-50 to-white rounded-xl shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 mt-10 gap-8 md:px-10 md:gap-16">
        ...
        <div className="col-span-12 md:col-span-5 flex justify-center md:justify-end" data-aos="fade-up">
          <div className="relative w-[80%] max-w-xs md:max-w-sm mx-auto">
            <Image
        ...
        {/* Text Content */}
        <div className="col-span-12 md:col-span-7 text-start" data-aos="fade-up">
